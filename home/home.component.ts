...
@Component({
  selector: 'app-home',
  standalone: true,
  imports: [CommonModule, HeaderComponent, AboutComponent, ProjectsComponent, ServiceComponent, FooterComponent,ProjectTreeComponent, WhyComponent, TeamComponent, RouterOutlet, FormsModule, HttpClientModule, ReactiveFormsModule],
